...
//        $picture = $_POST["file"];
        ...
        include "dblink.php";
        $sql = "INSERT INTO `news` (`aid`, `name`, `picture`, `info`, `date`) VALUES ('$id', '$name', '$file', '$info', '$date');";
//        $sql = "INSERT INTO `news` (`aid`, `name`, `info`, `date`) VALUES ('$id', '$name', '$info', '$date');";
        $result = mysqli_query($link, $sql);
        header("Location: news_ma.php");
        mysqli_close($link);
        }
  ...
  <div class="container">
    <div class="row">
        <div class="col-md-12 col-lg-12 mb-5">
           <font size="20"><b>新增活動表單</b></font>
            <form class="p-5 bg-white" method="post" enctype="multipart/form-data">
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">消息代碼</label>
