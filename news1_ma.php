    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(images/news.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">最新消息</h1>
        </div>
      </div>
    </div>
    <div align="center">
      ...
      <br>
      <br>
       <a href="new_news1_ma.php" class="btn btn-primary text-white px-4"><span class="caption">我要新增消息</span></a> 
    </div>
            ...
            <div class="media-image">
              ...
              <div class="media-image-body">
                ...
                <p align="right">發布日期<?php echo $row["date"] ?></p>
                 <p><a href="edit_news1_ma.php?id=<?php echo $row["aid"]?>" class="btn btn-primary text-white px-4"><span class="caption">修改</span></a>&nbsp; <a href="del_news1.php?id=<?php echo $row["aid"]?>" class="btn btn-primary text-white px-4"><span class="caption">刪除</span></a></p>
              </div>
            </div>
          </div>
          <?php
